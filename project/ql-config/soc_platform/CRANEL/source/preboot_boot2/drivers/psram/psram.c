...
void psram_init(void)
{
     ...
     * if do try download, the second preboot need set freq to min before pram init, or psram will hang
     */
    if (CHIP_ID_CRANE == hw_chip_id() ||
        CHIP_ID_CRANEL == hw_chip_id() ||
...
static const struct PsramPP_t PsramPP_crane[] =
{
    ...
    /*LV0:     78M*/ { 78, 0x0, 1 },    // PLL1_156 -- 156/2 clock -- 78MMHz
    /*LV0:  156MHz*/ { 156, 0x3, 1 },   // PLL1_312 -- 312/2 clock -- 156MMHz
    /*LV1:  175MHz*/ { 175, 0x1, 1 },   // PLL1_350 -- 350/2 clock -- 175MHz
    /*LV2:  208MHz*/ { 208, 0x2, 1 },   // PLL1_416 -- 416/2 clock -- 208MHz
#else
    /*LV0:     78M*/ { 78, 0x5, 1 },    // PLL1_156 -- 156/2 clock -- 78MHz
    /*LV0:  156MHz*/ { 156, 0x0, 1 },   // PLL1_312 -- 312/2 clock -- 156MHz
    /*LV1:  175MHz*/ { 175, 0x1, 1 },   // PLL1_350 -- 350/2 clock -- 175MHz
    /*LV2:  208MHz*/ { 208, 0x2, 1 },   // PLL1_416 -- 416/2 clock -- 208MHz
#endif
};
