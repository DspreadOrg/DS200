...
**[LTE01R07A01_C_SDK_A_BETA0309][01] 2023-03-10**

**[LTE01R07A01_TRACKER_C_SDK_A_BETA0321][01] 2023-03-21**
 --1，新增fbf差分升级fota签名功能
 --2,修复QLTS指令使用引起的QENG指令无法正常使用的问题
 --3,修复小系统绑网卡异常fota失败
 --4，+CREG 兼容对于EPS ONLY网络拒绝值上报，对于LTEONLY的项目建议使用AT+CEREG?查询网络状态

**[LTE01R07A01_TRACKER_C_SDK_A_BETA0322][01] 2023-03-22**
 --1,STD项目 宇松定制 CCED指令格式修复 参考FAE-64297

**[LTE01R07A02_C_SDK_A_BETA0328][01] 2023-03-28**

**[LTE01R07A01_TRACKER_C_SDK_A_BETA0329][01] 2023-03-29**

**[LTE01R07A01_NOMINI_C_SDK_A_BETA0331][01] 2023-04-01**

**[LTE01R07A02_C_SDK_A_BETA0404A][01] 2023-04-04**

**[LTE01R07A01_BDA_C_SDK_A][01] 2023-04-12**

**[LTE01R07A01_BDA_C_SDK_A_BETA0413][01] 2023-04-13**

**[LTE01R07A01_TRACKER_C_SDK_A_BETA0413][01] 2023-04-13**

**[LTE01R07A03_C_SDK_A_BETA0414][01] 2023-04-14**

**[LTE01R07A03_C_SDK_A_BETA0421][01] 2023-04-21**
 --1,修复华宝PDP Remap、脉隆开机阶段输入AT*CELL=0,概率性PC网卡IP与PDP不一致问题

**[LTE01R07A03_C_SDK_A_BETA0424][01] 2023-04-24**

**[LTE01R07A01_BDA_C_SDK_A_BETA0424][01] 2023-04-24**

**[LTE01R07A03_C_SDK_A_BETA0504][01] 2023-05-04**
 --1，解决BIP下udp建立socket失败的问题；EAB功能配置指定的AC等级不生效的问题

**[LTE01R07A03_C_SDK_A_BETA0505][01] 2023-05-05**
 --1,修复被错误裁剪的audioloop指令
 --2，解决BIP下udp建立socket失败的问题；EAB功能配置指定的AC等级不生效的问题

**[LTE01R07A01_DBA_C_SDK_A_BETA0508][01] 2023-05-08**

**[LTE01R07A01_BDA_C_SDK_A_BETA0510][01] 2023-05-10**

**[LTE01R07A02_TRACKER_C_SDK_A_BETA0513][01] 2023-05-13**
 --1，新增支持设置url后进行边下载边升级的全量升级app方案

**[LTE01R07A01_BDA_C_SDK_A_BETA0519][01] 2023-05-19**
 --1，解决AT+CPBR返回结果少了\r\n的问题
 --2，播报延时优化
 --3,修复OPEN 8M LTEONLY THIN项目双卡被裁剪问题
 --4，使能PB功能AT命令
 --5/N，为Y时，填写RN描述
 --6/N，为Y时，填写RN描述
 --7，新增支持设置url后进行边下载边升级的全量升级app方案
 --8，新增支持设置url后进行边下载边升级的全量升级app方案

**[LTE01R07A01_BDA_C_SDK_A_BETA0525][01] 2023-05-25**

**[LTE01R07A01_BDA_C_SDK_A_BETA0602][01] 2023-06-02**

**[LTE01R07A03_C_SDK_A_BETA0609][01] 2023-06-09**
 --1/N，为Y时，填写RN描述

**[LTE01R07A03_TRACKER_C_SDK_A][01] 2023-06-10**
 --1/N，为Y时，填写RN描述
 --2/N，为Y时，填写RN描述

**[LTE01R07A01_BDA_C_SDK_A_BETA0619][01] 2023-06-19**
 --1,修复开机设置音频参数死机问题
 --2，THIN M2 版本使能SIM卡热插拔
 --3/N，为Y时，填写RN描述
 --4/N，为Y时，填写RN描述

**[LTE01R07A04_C_SDK_A_BETA0626][01] 2023-06-26**
 --1,优化camera预览噪点问题
 --2,修复开机设置音频参数死机问题
 --3，THIN M2 版本使能SIM卡热插拔
 --4/N，为Y时，填写RN描述
 --5/N，为Y时，填写RN描述

**[LTE01R07A03_TRACKER_C_SDK_A_BETA0626][01] 2023-06-26**
 --1,优化camera预览噪点问题
 --2,修复开机设置音频参数死机问题
 --3，THIN M2 版本使能SIM卡热插拔
 --4/N，为Y时，填写RN描述
...
**[LTE01R07A04_C_SDK_A_BETA0629][01] 2023-06-30**
 --1,新增备份app功能
 --2,优化camera预览噪点问题
 --3,修复开机设置音频参数死机问题
 --4，THIN M2 版本使能SIM卡热插拔
 --5/N，为Y时，填写RN描述
 --6/N，为Y时，填写RN描述
