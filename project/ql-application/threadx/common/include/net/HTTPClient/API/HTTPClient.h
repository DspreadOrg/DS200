...
#define HTTP_CLIENT_MAX_SEND_RECV_HEADERS   3096        // Maximum Send and receive buffers size
...
//        fd_set              FDError;            // socket error event
	...
	int (*httpread)(void *, unsigned char *, int);
	int (*httpwrite)(void *, unsigned char *, int);
...
UINT32                  HTTPIntrnRecv                 (P_HTTP_SESSION pHTTPSession, CHAR *pData,UINT32 *nLength);
